// const caption = document.getElementsByClassName('carousel-item active');
// console.log(caption.item(0).children[1].innerHTML);

//$('.carousel').carousel()
const caption = document.getElementsByClassName('carousel-item active');
const outer = document.getElementsByClassName('carousel-outer');


$('#carouselExampleSlidesOnly').on('slid.bs.carousel', function () {
    outer.item(0).innerHTML = "";
    outer.item(0).innerHTML += (caption.item(0).children[1].innerHTML);
});
